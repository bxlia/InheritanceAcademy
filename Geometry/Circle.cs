...
namespace Geometry
{
    internal class Circle:Shape
    {
        ...
        public void DrawDiameter(PaintEventArgs e) => e.Graphics.DrawLine(new System.Drawing.Pen(Color, 1), StartX + Radius, StartY, StartX + Radius, StartY + (float)GetDiameter());
